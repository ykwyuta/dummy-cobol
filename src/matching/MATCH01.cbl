       ...
       FILE-CONTROL.
           SELECT MASTER-IN ASSIGN TO
                  "data/matching/MASTER.DAT"
                  ORGANIZATION IS LINE SEQUENTIAL.
           SELECT TRAN-IN ASSIGN TO
                  "data/matching/TRAN.DAT"
                  ORGANIZATION IS LINE SEQUENTIAL.
           SELECT NEW-MASTER-OUT ASSIGN TO
                  "data/matching/NEWMAST.DAT"
                  ORGANIZATION IS LINE SEQUENTIAL.
           SELECT ERROR-REPORT ASSIGN TO
                  "data/matching/ERROR.LST"
                  ORGANIZATION IS LINE SEQUENTIAL.
