       ...
       FILE-CONTROL.
           SELECT MASTER-IN ASSIGN TO "data/MASTER.DAT"
                  ORGANIZATION IS LINE SEQUENTIAL.
           SELECT TRAN-IN ASSIGN TO "data/TRAN.DAT"
                  ORGANIZATION IS LINE SEQUENTIAL.
           SELECT NEW-MASTER-OUT ASSIGN TO "data/NEWMAST.DAT"
                  ORGANIZATION IS LINE SEQUENTIAL.
           SELECT ERROR-REPORT ASSIGN TO "data/ERROR.LST"
                  ORGANIZATION IS LINE SEQUENTIAL.
